#Moving onto something a bit more riveting: data types. What if I want something that contains a word? or a number? or anything? Well Pythons got you covered...
